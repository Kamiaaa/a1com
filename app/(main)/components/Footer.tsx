...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: "+8809644219999 (NOC), 01824382951 (what's app), 01824382952", link: 'tel:09542366393' },
    ...
    { icon: <Clock className="w-5 h-5" />, label: 'Business Hours', value: 'Sat - Fri: 10:00 AM - 7:00 PM', link: null },
  ];
